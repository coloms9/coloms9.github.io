...
# 1201 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    if ((*fmt)[0] == '%') {
        ...
        while (!done) {
            switch ((*fmt)[0]) {
# 1231 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
                case ' ' :
                    flags |= (1 << 3);
                    ++*fmt;
                    break;
...
# 1291 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
  ...
  c = *cp;
  switch(c) {
# 1323 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
   case 't':
    ...
    cp++;
    break;
# 1338 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
   case 'i':
   case 'd':
# 1350 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    c = 'i';
    break;
   default :
    c = 0;
  ...
  if (*cp == 'd' || *cp == 'i') {
   ...
   switch (c) {
    case 'i':
     ...
     break;
# 1388 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
    case 't':
     convarg.sint = (vfpf_sint_t)(*(ptrdiff_t *)__va_arg(*(ptrdiff_t **)ap, (ptrdiff_t)0));
     break;
# 1402 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
   }
...
# 1689 "/opt/microchip/xc8/v2.45/pic/sources/c99/common/doprnt.c"
  cp = *fmt;
  c = *cp;
  switch(c) {
